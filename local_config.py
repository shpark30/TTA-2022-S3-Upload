DATA_INFO_PATH = "W:/2022 TTA/2022 검사 제반 자료 이관/{0}/data_info.csv"
RESULT_DIR_ORIGINAL = "W:/2022 TTA/2022 검사 제반 자료 이관/{0}/검사 결과/{1}"
RESULT_DIR_EDIT = "W:/2022 TTA/2022 검사 제반 자료 이관/{0}/검사 결과/EDIT"
REPORT_DIR_ORIGINAL = "W:/2022 TTA/2022 검사 제반 자료 이관/{0}/체크리스트/{1}"
REPORT_DIR_EDIT = "W:/2022 TTA/2022 검사 제반 자료 이관/{0}/체크리스트/EDIT"
RULE_DIR_EDIT = "W:/2022 TTA/2022 검사 제반 자료 이관/{0}/검사 규칙/{1}"
